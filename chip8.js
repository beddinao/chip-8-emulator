...
var _emscripten_get_main_loop_timing = (mode, value) => {
  if (mode) _asan_js_store_4(((mode) >> 2), MainLoop.timingMode);
  if (value) _asan_js_store_4(((value) >> 2), MainLoop.timingValue);
};
...
var fillOrientationChangeEventData = eventStruct => {
  ...
  _asan_js_store_4(((eventStruct) >> 2), orientationIndex);
  _asan_js_store_4((((eventStruct) + (4)) >> 2), orientationAngle);
};
...
/** @suppress {duplicate } */ var _emscripten_webgl_do_create_context = (target, attributes) => {
  ...
  var powerPreference = _asan_js_load_4(attr32 + (8 >> 2));
  var contextAttributes = {
    "alpha": !!_asan_js_load_1(attributes + 0),
    "depth": !!_asan_js_load_1(attributes + 1),
    "stencil": !!_asan_js_load_1(attributes + 2),
    "antialias": !!_asan_js_load_1(attributes + 3),
    "premultipliedAlpha": !!_asan_js_load_1(attributes + 4),
    "preserveDrawingBuffer": !!_asan_js_load_1(attributes + 5),
    "powerPreference": webglPowerPreferences[powerPreference],
    "failIfMajorPerformanceCaveat": !!_asan_js_load_1(attributes + 12),
    // The following are not predefined WebGL context attributes in the WebGL specification, so the property names can be minified by Closure.
    majorVersion: _asan_js_load_4(attr32 + (16 >> 2)),
    minorVersion: _asan_js_load_4(attr32 + (20 >> 2)),
    enableExtensionsByDefault: _asan_js_load_1(attributes + 24),
    explicitSwapControl: _asan_js_load_1(attributes + 25),
    proxyContextToMainThread: _asan_js_load_4(attr32 + (28 >> 2)),
    renderViaOffscreenBackBuffer: _asan_js_load_1(attributes + 32)
  };
  var canvas = findCanvasEventTarget(target);
  if (!canvas) {
    return 0;
...
var ASM_CONSTS = {
  ...
  306948109: () => Module["SDL3"].audioContext.sampleRate,
  306948160: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  306953714: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  306953773: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  306959560: () => Module["SDL3"]["mouse_x"],
  306959598: () => Module["SDL3"]["mouse_y"],
  306959636: $0 => Module["SDL3"]["mouse_buttons"][$0],
  306959684: $0 => {
      ...
      var makePointerEventCStruct = function(event) {
        ...
        if (event.pointerType == "pen") {
          ...
          if (ptr != 0) {
            ...
            var idx = ptr >> 2;
            _asan_js_store_4(idx++, event.pointerId);
            _asan_js_store_4(idx++, (typeof (event.button) !== "undefined") ? event.button : -1);
            _asan_js_store_4(idx++, event.buttons);
            _asan_js_store_f(idx++, event.movementX);
            _asan_js_store_f(idx++, event.movementY);
            _asan_js_store_f(idx++, event.clientX - rect.left);
            _asan_js_store_f(idx++, event.clientY - rect.top);
            _asan_js_store_f(idx++, event.pressure);
            _asan_js_store_f(idx++, event.tangentialPressure);
            _asan_js_store_f(idx++, event.tiltX);
            _asan_js_store_f(idx++, event.tiltY);
            _asan_js_store_f(idx++, event.twist);
          }
        }
        return ptr;
      };
    ...
    if (target) {
      ...
      var makeDropEventCStruct = function(event) {
        ...
        if (ptr != 0) {
          var idx = ptr >> 2;
          var rect = target.getBoundingClientRect();
          _asan_js_store_4(idx++, event.clientX - rect.left);
          _asan_js_store_4(idx++, event.clientY - rect.top);
        }
        return ptr;
      };
  ...
  306965773: () => window.innerWidth,
  306965803: () => window.innerHeight,
  306965834: $0 => {
...
var _exec_clr = Module["_exec_clr"] = () => (_exec_clr = Module["_exec_clr"] = wasmExports["exec_clr"])();

var _exec_ldp = Module["_exec_ldp"] = (a0, a1) => (_exec_ldp = Module["_exec_ldp"] = wasmExports["exec_ldp"])(a0, a1);
...
var _render_display = Module["_render_display"] = a0 => (_render_display = Module["_render_display"] = wasmExports["render_display"])(a0);
...
var __ZN6__asan9FakeStack17AddrIsInFakeStackEm = Module["__ZN6__asan9FakeStack17AddrIsInFakeStackEm"] = (a0, a1) => (__ZN6__asan9FakeStack17AddrIsInFakeStackEm = Module["__ZN6__asan9FakeStack17AddrIsInFakeStackEm"] = wasmExports["_ZN6__asan9FakeStack17AddrIsInFakeStackEm"])(a0, a1);

var __ZN6__asan9FakeStack8AllocateEmmm = Module["__ZN6__asan9FakeStack8AllocateEmmm"] = (a0, a1, a2, a3) => (__ZN6__asan9FakeStack8AllocateEmmm = Module["__ZN6__asan9FakeStack8AllocateEmmm"] = wasmExports["_ZN6__asan9FakeStack8AllocateEmmm"])(a0, a1, a2, a3);
...
function callMain(args = []) {
  ...
  var argv_ptr = argv;
  args.forEach(arg => {
    _asan_js_store_4u(((argv_ptr) >> 2), stringToUTF8OnStack(arg));
    argv_ptr += 4;
  });
  _asan_js_store_4u(((argv_ptr) >> 2), 0);
  try {
