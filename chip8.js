...
var ASM_CONSTS = {
  ...
  306947949: () => Module["SDL3"].audioContext.sampleRate,
  306948e3: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  306953554: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  306953613: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  306959400: () => Module["SDL3"]["mouse_x"],
  306959438: () => Module["SDL3"]["mouse_y"],
  306959476: $0 => Module["SDL3"]["mouse_buttons"][$0],
  306959524: $0 => {
  ...
  306965613: () => window.innerWidth,
  306965643: () => window.innerHeight,
  306965674: $0 => {
